...
class Lion extends Animal{
    ...
    // adding same method in child class comment eat method of Child class it will call eat() method of parent class
    eat(){
        return `${this.name} is eating and running at speed ${this.speed}kmph`;
    };
